...
C
     ...
     &           'STOB', 'HUF2', 'CHOB', 'ETS ', 'DRT ', 'DRNO', 'GMG ',  ! 42
...
! Allocate arrays for Newton Solver
     ...
     1                                   IUNIT(22),IGRID)
      ...
      IF(IUNIT(41).GT.0) CALL GWF2DRNO1AR(IUNIT(41),IGRID)
...
C----------READ USING PACKAGE READ AND PREPARE MODULES.
        ...
        IF(IUNIT(41).GT.0) CALL GWF2DRNO1RP(IUNIT(41),IUNIT(44),IGRID)
...
C7C2A---FORMULATE THE FINITE DIFFERENCE EQUATIONS.
     ...
     1                             KKSTP,KKPER,IUNIT(47),IGRID)
            ...
            IF(IUNIT(41).GT.0) CALL GWF2DRNO1FM(IGRID,IUNIT(44))
...
159         CONTINUE
          ...
          IF(IUNIT(41).GT.0) CALL GWF2DRNO1BD(KKSTP,KKPER,IGRID)
...
C9------LAST BECAUSE IT DEALLOCATES IUNIT.
      ...
      IF(IUNIT(41).GT.0) CALL GWF2DRNO1DA(IGRID)
